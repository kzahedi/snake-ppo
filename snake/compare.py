...
from snake.eval import evaluate, _NetAgent, _QNetAgent, _make_baseline
...
def main():
    ...
    agents = [_NetAgent(rd, H, W) for rd in args.ppo]
    agents += [_QNetAgent(rd, H, W) for rd in args.dqn]
