...
## Headline comparison (8×8, 40 eval episodes; learned methods at 20M steps)
...
| `runs/a2c` | A2C comparison run | complete (20M) | 5–8% fill |
| `runs/dqn` | DQN comparison run | complete (20M) | 37% fill |
| `runs/evo` | neuroevolution comparison run | complete | 5% fill |
